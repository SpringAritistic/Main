 ...
 * Layer Data.
 */
struct HM_CAD_EXT DL_LayerData {
    /**
     * Constructor.
 ...
 * Block Data.
 */
struct HM_CAD_EXT DL_BlockData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Line Type Data.
 */
struct HM_CAD_EXT DL_LinetypeData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Text style data.
 */
struct HM_CAD_EXT DL_StyleData {
    /**
     * Constructor
     * Parameters: see member variables.
     */
 ...
 * Point Data.
 */
struct HM_CAD_EXT DL_PointData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * XLine Data.
 */
struct HM_CAD_EXT DL_XLineData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Circle Data.
 */
struct HM_CAD_EXT DL_CircleData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Polyline Data.
 */
struct HM_CAD_EXT DL_PolylineData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Vertex Data.
 */
struct HM_CAD_EXT DL_VertexData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_TraceData {
    DL_TraceData() {
        thickness = 0.0;
        for (int i=0; i<4; i++) {
            x[i] = 0.0;
 ...
 * Spline Data.
 */
struct HM_CAD_EXT DL_SplineData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_ControlPointData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_FitPointData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Ellipse Data.
 */
struct HM_CAD_EXT DL_EllipseData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Insert Data.
 */
struct HM_CAD_EXT DL_InsertData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * MText Data.
 */
struct HM_CAD_EXT DL_MTextData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_ArcAlignedTextData {
 ...
 */
struct HM_CAD_EXT DL_AttributeData : public DL_TextData {
 ...
 */
struct HM_CAD_EXT DL_DimensionData {
    /**
    * Constructor.
    * Parameters: see member variables.
    */
 ...
 */
struct HM_CAD_EXT DL_DimAlignedData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_DimLinearData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_DimRadialData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_DimDiametricData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_DimAngularData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_DimAngular3PData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_DimOrdinateData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Leader (arrow).
 */
struct HM_CAD_EXT DL_LeaderData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Leader Vertex Data.
 */
struct HM_CAD_EXT DL_LeaderVertexData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Hatch data.
 */
struct HM_CAD_EXT DL_HatchData {
    /**
     * Default constructor.
     */
    DL_HatchData() {}
 ...
 */
struct HM_CAD_EXT DL_HatchLoopData {
    /**
     * Default constructor.
     */
    DL_HatchLoopData() {}
 ...
 * Hatch edge data.
 */
struct HM_CAD_EXT DL_HatchEdgeData {
    /**
     * Default constructor.
     */
 ...
 * Image Data.
 */
struct HM_CAD_EXT DL_ImageData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 */
struct HM_CAD_EXT DL_ImageDefData {
    /**
     * Constructor.
     * Parameters: see member variables.
     */
 ...
 * Dictionary data.
 */
struct HM_CAD_EXT DL_DictionaryData {
 ...
 */
struct HM_CAD_EXT DL_DictionaryEntryData {
