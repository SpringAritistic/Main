...
void DL_Dxf::writeMText(DL_WriterA& dw,
    ...
    for (i=250; i<length; i+=250) {
        strncpy_s(chunk, &data.text.c_str()[i-250], 250);
        chunk[250]='\0';
...
void DL_Dxf::test() {
	...
	strcpy_s(buf1, len, "  10\n");
	strcpy_s(buf2, len, "10");
	strcpy_s(buf3, len, "10\n");
	strcpy_s(buf4, len, "  10 \n");
	strcpy_s(buf5, len, "  10 \r");
	strcpy_s(buf6, len, "\t10 \n");
