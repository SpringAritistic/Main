...
BEGIN_MESSAGE_MAP(CDialogTestApp, CBCGPWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDialogTestApp::OnAppAbout)
...
CDialogTestApp::CDialogTestApp()
{
	...
	SetAppID(_T("DialogTest.AppID.NoVersion"));
...
BOOL CDialogTestApp::InitInstance()
{
	...
	CBCGPWinApp::InitInstance();
	CBCGPWinApp::SetRegistryKey(_T("MyCompany\\MyProduct"));
	//CBCGPWinApp::AfxOleInit();
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDialogTestDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CDialogTestView));
	if (!pDocTemplate)
		return FALSE;
...
// CDialogTestApp message handlers
...
void CDialogTestApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
