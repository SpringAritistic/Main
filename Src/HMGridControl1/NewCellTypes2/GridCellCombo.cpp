...
//
// History:
// 6 Aug 1998 - Added HMComboEdit to subclass the edit control - code 
...
#include "HMGridControl/GridCellCombo.h"
...
BEGIN_MESSAGE_MAP(HMComboEdit, CEdit)
	//{{AFX_MSG_MAP(HMComboEdit)
	ON_WM_KILLFOCUS()
	ON_WM_KEYDOWN()
	ON_WM_KEYUP()
	//}}AFX_MSG_MAP
...
IMPLEMENT_DYNCREATE(HMGridCellCombo, HMGridCell)
