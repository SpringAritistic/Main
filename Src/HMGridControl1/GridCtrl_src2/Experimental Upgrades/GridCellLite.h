...
class HMGridCtrl ;
#include "HMGridControl/GridCellBase.h"
...
public:
	...
	static const LOGFONT* GetDefFont()          { return &m_lfDefFont; }
	static UINT     GetDefMargin()              { return m_nDefMargin; }
...
public:
    ...
    virtual void SetGrid(HMGridCtrl * pGrid)      { m_pGrid = pGrid; }                          
 ...
 // virtual void SetState(DWORD nState);  -  use base class version   
    ...
    virtual HMGridCtrl* GetGrid()                { return m_pGrid;   }
