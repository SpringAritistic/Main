...
private:
	...
	{
		ALLOWROWRESIZE = 1,                           //1_:_1
		ALLOWCOLUMNRESIZE = ALLOWROWRESIZE << 1,      //2_:_2
		ALLOWDRAGANDDROP = ALLOWCOLUMNRESIZE << 1,    //3_:_4
		ALLOWDRAW = ALLOWDRAGANDDROP << 1,            //4_:_8
		ALLOWREORDERCOLUMN = ALLOWDRAW << 1,          //5_:_16
		ALLOWCOLHIDE = ALLOWREORDERCOLUMN << 1,       //6_:_32
		ALLOWROWHIDE = ALLOWCOLHIDE << 1,             //7_:_64
		ALLOWSELECTROWINFIXEDCOL = ALLOWROWHIDE << 1, //8_:_128
		ASCEND = ALLOWSELECTROWINFIXEDCOL << 1,       //9_:_256
		AUTOSIZESKIPCOLHDR = ASCEND << 1,             //10_:_512
		DOUBLEBUFFER = AUTOSIZESKIPCOLHDR << 1,       //11_:_1024
		DROPCOPY = DOUBLEBUFFER << 1,                 //12_:_2048
		EDITABLE = DROPCOPY << 1,                     //13_:_4096
		ENABLESELECTION = EDITABLE << 1,              //14_:_8192
		FIXEDROWSELECTION = ENABLESELECTION << 1,     //15_:_16384
		FIXEDCOLUMNSELECTION = FIXEDROWSELECTION << 1,//16_:_32768
		FRAMEFOCUS = FIXEDCOLUMNSELECTION << 1,       //17_:_65536
		HANDLETABKEY = FRAMEFOCUS << 1,               //18_:_131072
		HIDDENCOLUNHIDE = HANDLETABKEY << 1,          //19_:_262144
		HIDDENROWUNHIDE = HIDDENCOLUNHIDE << 1,       //20_:_524288
		INDESTRUCTOR = HIDDENROWUNHIDE << 1,          //21_:_1048576
		LISTMODE = INDESTRUCTOR << 1,                 //22_:_2097152
		MODIFIED = LISTMODE << 1,                     //23_:_4194304
		QUITFOCUSONTAB = MODIFIED << 1,               //24_:_8388608
		LMOUSEBUTTONDOWN = QUITFOCUSONTAB << 1,       //25_:_16777216
		RMOUSEBUTTONDOWN = LMOUSEBUTTONDOWN << 1,     //26_:_33554432
		...
		SHADEDPRINTOUT = RMOUSEBUTTONDOWN << 1,       //27_:_67108864
		SINGLECOLSELECTION = SHADEDPRINTOUT << 1,     //28_:_134217728
		SINGLEROWSELECTION = SINGLECOLSELECTION << 1, //29_:_268435456
		SORTONCLICK = SINGLEROWSELECTION << 1,        //30_:_536870912
		STARTCUT = SORTONCLICK << 1,                  //31_:_1073741824
		TITLETIPS = STARTCUT << 1,                    //32_:_2147483648
		TRACKFOCUSCELL = TITLETIPS << 1,              //33_:_4294967296
		VIRTUALMODE = TRACKFOCUSCELL << 1,            //34_:_8589934592
		// EFW - New printing support functions                                              
		WYSIWYGPRINTING = VIRTUALMODE << 1,           //35_:_17179869184
		DRAGROWMODE = WYSIWYGPRINTING << 1,           //36_:_34359738368
