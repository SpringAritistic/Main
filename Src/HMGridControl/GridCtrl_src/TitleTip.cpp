...
BEGIN_MESSAGE_MAP(HMTitleTip, CWnd)
	//{{AFX_MSG_MAP(HMTitleTip)
	ON_WM_MOUSEMOVE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// HMTitleTip message handlers

BOOL HMTitleTip::Create(CWnd * pParentWnd)
{
...
void HMTitleTip::OnMouseMove(UINT nFlags, CPoint point) 
{
...
BOOL HMTitleTip::PreTranslateMessage(MSG* pMsg) 
{
...
void HMTitleTip::SetParentWnd(CWnd* pParentWnd)  { m_pParentWnd = pParentWnd; }
CWnd* HMTitleTip::GetParentWnd()                 { return m_pParentWnd; }
