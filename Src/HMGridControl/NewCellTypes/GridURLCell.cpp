...
IMPLEMENT_DYNCREATE(HMGridURLCell, HMGridCell)

#ifndef _WIN32_WCE
HCURSOR HMGridURLCell::g_hLinkCursor = NULL;
#endif

// Possible prefixes that indicate a hyperlink
URLStruct HMGridURLCell::g_szURIprefixes[] = { 
...
BOOL HMGridURLCell::Draw(CDC* pDC, int nRow, int nCol, CRect rect, BOOL bEraseBkgnd)
{
...
BOOL HMGridURLCell::Edit(int nRow, int nCol, CRect rect, CPoint point, UINT nID, UINT nChar)
{
    return FALSE;
}
#pragma warning(default:4100)

void HMGridURLCell::OnClick(CPoint PointCellRelative)
{
#ifndef _WIN32_WCE
    CString strURL;
...
BOOL HMGridURLCell::OnSetCursor()
{
#ifndef _WIN32_WCE
    CString strURL;
...
#endif
		return HMGridCell::OnSetCursor();
}

#ifndef _WIN32_WCE
HCURSOR HMGridURLCell::GetHandCursor()
{
...
BOOL HMGridURLCell::HasUrl(CString str)
{
...
BOOL HMGridURLCell::OverURL(CPoint& pt, CString& strURL)
{
...
LPCTSTR  HMGridURLCell::GetTipText() { return NULL; }
void HMGridURLCell::SetAutoLaunchUrl(BOOL bLaunch ) { m_bLaunchUrl = bLaunch; }
BOOL HMGridURLCell::GetAutoLaunchUrl() { return m_bLaunchUrl; }
_HM_GridControl_END
