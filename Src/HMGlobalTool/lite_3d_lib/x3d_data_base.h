...
// 有需要请使用其它常规矩阵的类或开源库
class HM_GlobalTool_EXT x3d_trans_matrix
{
public:
...
// 表示一个三维向量或三维点
class HM_GlobalTool_EXT x3d_vector
{
public:
	x3d_vector();
...
class HM_GlobalTool_EXT x3d_color
{
public:
...
class HM_GlobalTool_EXT x3d_vertex
{
public:
	x3d_vertex();
...
class HM_GlobalTool_EXT x3d_aabb_box
{
public:
	x3d_aabb_box();
...
class HM_GlobalTool_EXT x3d_graph_unit
{
public:
...
// 定义一个3d模型的通用数据基类
class HM_GlobalTool_EXT x3d_node_base : public data_node_base
{
...
class HM_GlobalTool_EXT x3d_node_group : public x3d_node_base
{
...
class HM_GlobalTool_EXT x3d_graph : public x3d_node_base
{
...
class HM_GlobalTool_EXT x3d_geometry_base : public x3d_node_base
{
...
// 表示三维空间中的建模操作的基类
class HM_GlobalTool_EXT x3d_action_base : public CObject, public serialize_interface
{
...
// 表示三维空间中的一个平面
class HM_GlobalTool_EXT x3d_plane
{
public:
	x3d_plane();
...
class HM_GlobalTool_EXT x3d_action_section
{
public:
	struct point
	{
