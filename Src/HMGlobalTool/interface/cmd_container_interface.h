...
// 使用post方式异步执行命令调用对象
class HM_GlobalTool_EXT command_post_doing_function : public functor_by_message
{
public:
...
class HM_GlobalTool_EXT cmd_container_interface
{
public:
...
// 命令管理类
class HM_GlobalTool_EXT cmd_trigger_manager
{
public:
...
HM_GlobalTool_EXT cmd_container_interface* register_auto_gc_cmd_and_return_object(cmd_container_interface* obj);
