...
// 皮肤和主题相关参数
struct HM_GlobalTool_EXT theme_style_settings
{
...
class HM_GlobalTool_EXT functor_by_message
{
public:
	functor_by_message();
...
class HM_GlobalTool_EXT app_ui_interface
{
public:
	app_ui_interface();
...
HM_GlobalTool_EXT app_ui_interface* get_app_ui_interface();
HM_GlobalTool_EXT void set_app_ui_interface(app_ui_interface* app);
