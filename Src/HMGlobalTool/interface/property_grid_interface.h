...
class HM_GlobalTool_EXT property_notification_interface
{
public:
...
class HM_GlobalTool_EXT property_window_interface
{
public:
...
HM_GlobalTool_EXT property_window_interface* get_property_window();
HM_GlobalTool_EXT void set_property_window(property_window_interface* obj);
