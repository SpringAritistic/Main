...
// 使用post方式异步触发通知
class X_FRAMEWORK_API notify_post_doing_function : public functor_by_message
{
public:
...
class X_FRAMEWORK_API data_node_base : public CObject, public serialize_interface
{
...
class X_FRAMEWORK_API data_mfc_object_can_copy_base : public CObject
{
public:
...
class X_FRAMEWORK_API data_class_none_copy_base
{
public:
...
class X_FRAMEWORK_API data_class_toolkit_base
{
private:
...
class X_FRAMEWORK_API data_node_notify_interface
{
public:
...
class X_FRAMEWORK_API data_node_notify_guard
{
public:
...
// 数据中心基类
class X_FRAMEWORK_API project_data_base : public data_node_base
{
...
class X_FRAMEWORK_API data_center
{
public:
	// 返回或设置数据中心文件支持的后缀过滤串
