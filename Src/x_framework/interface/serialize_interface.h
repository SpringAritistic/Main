...
class X_FRAMEWORK_API serialize_interface
{
public:
	serialize_interface();
...
class X_FRAMEWORK_API x_data_wrapper_buffer
{
public:
...
class X_FRAMEWORK_API x_object_flag_serialization_guard
{
public:
...
class X_FRAMEWORK_API x_array_flag_serialization_guard
{
public:
...
// pair<int, CString> test_pair;
// mt.read(x_wrapper_macro_named(_T("pair"), test_pair)); // 也可能使用读写接口
class X_FRAMEWORK_API member_rw_interface
{
public:
...
class X_FRAMEWORK_API bin_archive : public member_rw_interface
{
public:
...
class X_FRAMEWORK_API json_archive : public member_rw_interface
{
public:
...
class X_FRAMEWORK_API xml_archive : public member_rw_interface
{
public:
